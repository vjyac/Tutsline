...
<div class="main-content">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				{{ Form::open(array('url' => '/cursos/' . $curso->id . '/unidads/' . $unidad->id . '/capitulos/' . $capitulo->id . '/capitulospreguntas/' . $capitulospregunta->id . '/capitulosrespuestas', 'class' => 'form-horizontal form-groups-bordered', "autocomplete"=>"off")) }}
				{{ Form::hidden('_method', 'POST') }}
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
									<textarea class="form-control wysihtml5" name="capitulosrespuesta" id="capitulosrespuesta" rows="10"></textarea>
									<br>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div id="label-switch" class="make-switch" data-on-label="<i class='entypo-check'></i>" data-off-label="<i class='entypo-cancel'></i>">
								<input type="checkbox" id="correcta" name="correcta">
							</div>
						</div>
					</div>
