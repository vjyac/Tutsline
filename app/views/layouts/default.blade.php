...
<script src="/js/jvectormap/jquery-jvectormap-1.2.2.min.js" id="script-resource-7"></script>
<script src="/js/jvectormap/jquery-jvectormap-europe-merc-en.js" id="script-resource-8"></script>
<script src="/js/jquery.sparkline.min.js" id="script-resource-9"></script>
<script src="/js/rickshaw/vendor/d3.v3.js" id="script-resource-10"></script>
<script src="/js/rickshaw/rickshaw.min.js" id="script-resource-11"></script>
<script src="/js/raphael-min.js" id="script-resource-12"></script>
<script src="/js/morris.min.js" id="script-resource-13"></script>
<script src="/js/toastr.js" id="script-resource-14"></script>
