...
<div class="main-content">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				{{ Form::open(array('route' => 'areasinteress.store', "autocomplete"=>"off" , 'class' => 'form-horizontal form-groups-bordered', 'role' => 'form')) }}

					<div class="form-group">
						<label for="areasinteres" class="col-sm-3 control-label">Areas interes</label>
						<div class="col-sm-5">

									{{ Form::text('areasinteres', '', array('class' => 'form-control', 'name' => 'areasinteres', 'id' => 'areasinteres', 'placeholder' => 'Ingrese un areasinteres')) }}
									<br>
