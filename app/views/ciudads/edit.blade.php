...
<div class="main-content">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				{{ Form::open(array('url' => URL::to('/ciudads/' . $ciudad->id), 'method' => 'PUT', 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered')) }}

					<div class="form-group">
						<label for="ciudad" class="col-sm-3 control-label">Ciudad</label>
						<div class="col-sm-5">

								{{ Form::text('ciudad', $ciudad->ciudad, array('class' => 'form-control', 'name' => 'ciudad', 'id' => 'ciudad', 'placeholder' => 'Ingrese un ciudad')) }}
									<br>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							  <?php
								...
								?>
								{{ Form::text('estado', $estado->estado, array('class' => 'form-control typeahead', 'data-remote' => '/estados/search?term=%QUERY', 'name' => 'estado', 'id' => 'estado', 'placeholder' => 'Ingrese un estado')) }}
									<br>
